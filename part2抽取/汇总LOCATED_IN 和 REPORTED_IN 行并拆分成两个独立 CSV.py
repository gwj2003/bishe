...
def main() -> None:
    ...
    located_output = write_output(located_rows, Path("data/triplets/located_in_rows.csv"))
    reported_output = write_output(reported_rows, Path("data/triplets/reported_in_rows.csv"))
